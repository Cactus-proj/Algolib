...
# test69.tst: test for MultiSeries[multiseries] (no. 69)
...
#test 5
   ...
   #=============== test nb 69 =====================
   Order:=4;
   TRY[compare_SERIES]("69-1",
    op([assign(s=multiseries(op([exp(I*x), x = infinity, 4]))),SERIES2Series(s)]),
    Series([exp(I/_var[1/x])],0,algebraic,[0],infinity,integer,
    _var[1/x],exp(I/_var[1/x])));
   unassign('s');
