...
# test26.tst: test for MultiSeries[multiseries] (no. 26)
...
#test 5
   ...
   #=============== test nb 26 =====================
   Order:=4;
   TRY[compare_SERIES]("26-1",
    op([assign(s=multiseries(op([1/(x^Pi+x^(2^(1/2)))^4, x, 4]))),
    SERIES2Series(s)]),
    Series([1, -4, 10, -20],1,integer,
    [-4*2^(1/2), -5*2^(1/2)+Pi, -6*2^(1/2)+2*Pi, -7*2^(1/2)+3*Pi],-8*2^(1/2)+4*Pi,
    algebraic,_var[x],1/(_var[x]^Pi+_var[x]^(2^(1/2)))^4));
   unassign('s');
