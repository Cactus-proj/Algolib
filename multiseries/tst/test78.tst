...
# test78.tst: test for MultiSeries[multiseries] (no. 78)
...
#test 5
   ...
   #=============== test nb 78 =====================
   Order:=4;
   TRY[compare_SERIES]("78-1",
    op([assign(s=multiseries(op([1+ln(1/x), x, 4]))),SERIES2Series(s)]),
    Series([1+1/_var[1/ln(1/x)]],0,algebraic,[0],infinity,integer,_var[x],
    1+1/_var[1/ln(1/x)]));
   TRY[compare_SERIES]("78-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][1..1])),
    Series([1, 1],0,integer,[-1, 0],infinity,integer,_var[1/ln(1/x)],
    1+1/_var[1/ln(1/x)]));
   TRY[compare_SERIES]("78-3",
    SERIES2Series(multiseries(op(9,s),op(1,s))),
    Series([Series([1, 1],0,integer,[-1, 0],infinity,integer,_var[1/ln(1/x)],
    1+1/_var[1/ln(1/x)])],0,t_SERIES,[0],infinity,integer,_var[x],1+
    1/_var[1/ln(1/x)]));
   TRY[compare_SERIES]("78-4",
