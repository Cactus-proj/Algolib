...
# test36.tst: test for MultiSeries[multiseries] (no. 36)
...
#test 5
   ...
   #=============== test nb 36 =====================
   Order:=3;
   TRY[compare_SERIES]("36-1",
    op([assign(s=multiseries(op([1/x*exp(-(1/x)^(1/2)), x, 3]))),
    SERIES2Series(s)]),
    Series([Series([1],0,integer,[-1],infinity,integer,_var[x],1/_var[x])],
    0,t_SERIES,[1],infinity,integer,_var[1/exp(1/x^(1/2))],
    1/_var[x]*_var[1/exp(1/x^(1/2))]));
   TRY[compare_SERIES]("36-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][2..2])),
    Series([1/_var[x]],0,algebraic,[1],infinity,integer,
    _var[1/exp(1/x^(1/2))],1/_var[x]*_var[1/exp(1/x^(1/2))]));
   TRY[compare_SERIES]("36-3",
    SERIES2Series(multiseries(op(9,s),op(1,s))),
    Series([Series([1],0,integer,[-1],infinity,integer,_var[x],
    1/_var[x])],0,t_SERIES,[1],infinity,integer,_var[1/exp(1/x^(1/2))],
    1/_var[x]*_var[1/exp(1/x^(1/2))]));
   TRY[compare_SERIES]("36-4",
