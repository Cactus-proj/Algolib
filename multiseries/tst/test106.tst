...
# test106.tst: test for MultiSeries[multiseries] (no. 106)
...
#test 5
   ...
   #=============== test nb 106 =====================
   Order:=3;
   TRY[compare_SERIES]("106-1",
    op([assign(s=multiseries(op([GAMMA(x-21), x]))),SERIES2Series(s)]),
    Series([-1/51090942171709440000, -18858053/264302027132537780305920000+
    1/51090942171709440000*gamma, -353562301485889/22601955493239035206824257126400000-
    1/613091306060513280000*Pi^2+1/102181884343418880000*(18858053/5173168-gamma)^2-
    1/51090942171709440000*(-18858053/5173168+gamma)^2],1,algebraic,[-1, 0, 1],2,
    integer,_var[x],Pi/sin(Pi*(_var[x]-21))/GAMMA(22-_var[x])));
   unassign('s');
