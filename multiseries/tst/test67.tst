...
# test67.tst: test for MultiSeries[multiseries] (no. 67)
...
#test 5
   ...
   #=============== test nb 67 =====================
   Order:=3;
   TRY[compare_SERIES]("67-1",
    op([assign(s=multiseries(op([x^I, x]))),SERIES2Series(s)]),
    Series([exp(-I/_var[1/ln(1/x)])],0,algebraic,[0],infinity,integer,
    _var[x],exp(-I/_var[1/ln(1/x)])));
   TRY[compare_SERIES]("67-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][1..1])),
    Series([exp(-I/_var[1/ln(1/x)])],0,algebraic,[0],infinity,integer,
    _var[1/ln(1/x)],exp(-I/_var[1/ln(1/x)])));
   TRY[compare_SERIES]("67-3",
    SERIES2Series(multiseries(op(9,s),op(1,s))),
    Series([Series([exp(-I/_var[1/ln(1/x)])],0,algebraic,[0],infinity,
    integer,_var[1/ln(1/x)],exp(-I/_var[1/ln(1/x)]))],0,t_SERIES,[0],
    infinity,integer,_var[x],exp(-I/_var[1/ln(1/x)])));
   TRY[compare_SERIES]("67-4",
