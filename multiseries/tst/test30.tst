...
# test30.tst: test for MultiSeries[multiseries] (no. 30)
...
#test 5
   ...
   #=============== test nb 30 =====================
   Order:=3;
   TRY[compare_SERIES]("30-1",
    op([assign(s=multiseries(op([exp(1/x), x]))),SERIES2Series(s)]),
    Series([Series([1],0,integer,[0],infinity,integer,_var[x],1)],
    0,t_SERIES,[-1],infinity,integer,_var[1/exp(1/x)],1/_var[1/exp(1/x)]));
   TRY[compare_SERIES]("30-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][2..2])),
    Series([1],0,integer,[-1],infinity,integer,_var[1/exp(1/x)],
    1/_var[1/exp(1/x)]));
   TRY[compare_SERIES]("30-3",
