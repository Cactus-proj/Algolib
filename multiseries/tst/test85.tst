...
# test85.tst: test for MultiSeries[multiseries] (no. 85)
...
#test 6
   ...
   #=============== test nb 85 =====================
   Order:=4;
   TRY[compare_SERIES]("85-1",
    op([assign(s=multiseries(op([(x^x)^x, x, 4]))),SERIES2Series(s)]),
    Series([1, -1/_var[1/ln(1/x)], 1/2/_var[1/ln(1/x)]^2],ln(1/x)^4,
    algebraic,[0, 2, 4],5,integer,_var[x],exp(ln(exp(-1/_var[1/ln(1/x)]*
    _var[x]))*_var[x])));
   TRY[compare_SERIES]("85-2",
    ...
    t_SERIES,[0],2,integer,_var[x],exp(ln(exp(-1/_var[1/ln(1/x)]*
    _var[x]))*_var[x])));
   TRY[compare_SERIES]("85-4",
    ...
    -1/6/_var[1/ln(1/x)]^3)],
    Series([],1,integer,[],-4,integer,_var[1/ln(1/x)],1/24/
    _var[1/ln(1/x)]^4),t_SERIES,[0, 2, 4, 6],8,integer,_var[x],
    exp(ln(exp(-1/_var[1/ln(1/x)]*_var[x]))*_var[x])));
   unassign('s');
