...
# test14.tst: test for MultiSeries[multiseries] (no. 14)
...
#test 5
   ...
   #=============== test nb 14 =====================
   Order:=3;
   TRY[compare_SERIES]("14-1",
    op([assign(s=multiseries(op([1/(-1+x)^1., x]))),SERIES2Series(s)]),
    Series([-1., -1., -1.],1,float,[0., 1., 2.],3.,float,_var[x],
    1/(-1+_var[x])^1.));
   unassign('s');
