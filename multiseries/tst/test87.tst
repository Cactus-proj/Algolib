...
# test87.tst: test for MultiSeries[multiseries] (no. 87)
...
#test 6
   ...
   #=============== test nb 87 =====================
   Order:=3;
   TRY[compare_SERIES]("87-1",
    op([assign(s=multiseries(op([exp(ln(x)^2), x]))),SERIES2Series(s)]),
    Series([Series([1],0,integer,[0],infinity,integer,_var[x],1)],0,
    t_SERIES,[-1],infinity,integer,_var[1/exp(ln(1/x)^2)],
    1/_var[1/exp(ln(1/x)^2)]));
   TRY[compare_SERIES]("87-2",
    ...
    0,t_SERIES,[-1],infinity,integer,_var[1/exp(ln(1/x)^2)],
    1/_var[1/exp(ln(1/x)^2)]));
   TRY[compare_SERIES]("87-3",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][3..3])),
    Series([1],0,integer,[-1],infinity,integer,_var[1/exp(ln(1/x)^2)],
    1/_var[1/exp(ln(1/x)^2)]));
   TRY[compare_SERIES]("87-4",
    SERIES2Series(multiseries(op(9,s),op(1,s))),
    Series([Series([Series([1],0,integer,[0],infinity,integer,_var[1/ln(1/x)],1)],
    0,t_SERIES,[0],infinity,integer,_var[x],1)],0,t_SERIES,[-1],infinity,
    integer,_var[1/exp(ln(1/x)^2)],1/_var[1/exp(ln(1/x)^2)]));
   TRY[compare_SERIES]("87-5",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,exact_order)),
    Series([Series([Series([1],0,integer,[0],infinity,integer,
    _var[1/ln(1/x)],1)],0,t_SERIES,[0],infinity,integer,_var[x],1)],
    0,t_SERIES,[-1],infinity,integer,_var[1/exp(ln(1/x)^2)],
    1/_var[1/exp(ln(1/x)^2)]));
   unassign('s');
