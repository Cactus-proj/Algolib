...
# test71.tst: test for MultiSeries[multiseries] (no. 71)
...
#test 5
   ...
   #=============== test nb 71 =====================
   Order:=4;
   TRY[compare_SERIES]("71-1",
    op([assign(s=multiseries(op([exp((1+I)*x), x = infinity, 4]))),SERIES2Series(s)]),
    Series([Series([exp(I/_var[1/x])],0,algebraic,[0],infinity,integer,
    _var[1/x],exp(I/_var[1/x]))],0,t_SERIES,[-1],infinity,
    integer,_var[1/exp(x)],exp(I/_var[1/x])/
    _var[1/exp(x)]));
   TRY[compare_SERIES]("71-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][2..2])),
    Series([exp(I/_var[1/x])],0,algebraic,[-1],infinity,integer,
    _var[1/exp(x)],exp(I/_var[1/x])/_var[1/exp(x)]));
   TRY[compare_SERIES]("71-3",
    SERIES2Series(multiseries(op(9,s),op(1,s))),
    Series([Series([exp(I/_var[1/x])],0,algebraic,[0],infinity,
    integer,_var[1/x],exp(I/_var[1/x]))],0,t_SERIES,
    [-1],infinity,integer,_var[1/exp(x)],exp(I/_var[1/x])/
    _var[1/exp(x)]));
   TRY[compare_SERIES]("71-4",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,exact_order)),
    Series([Series([exp(I/_var[1/x])],0,algebraic,[0],infinity,
    integer,_var[1/x],exp(I/_var[1/x]))],0,
    t_SERIES,[-1],infinity,integer,_var[1/exp(x)],
    exp(I/_var[1/x])/_var[1/exp(x)]));
   unassign('s');
