...
# test19.tst: test for MultiSeries[multiseries] (no. 19)
...
#test 5
   ...
   #=============== test nb 19 =====================
   Order:=10;
   TRY[compare_SERIES]("19-1",
    member(op([assign(s=multiseries(op([1/(x^5+x^7)^3, x, 10]))),SERIES2Series(s)]),
[    
    Series([1, -3, 6, -10, 15, -21, 28, -36, 45, -55],1,integer,
    [-15, -13, -11, -9, -7, -5, -3, -1, 1, 3],5,integer,_var[x],
    1/(_var[x]^5+_var[x]^7)^3),
    Series([1, -3, 6, -10, 15, -21, 28],1,integer,
    [-15, -13, -11, -9, -7, -5, -3],-1,integer,_var[x],
    1/(_var[x]^5+_var[x]^7)^3)
]), true);
   unassign('s');
