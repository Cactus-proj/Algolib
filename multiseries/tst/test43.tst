...
# test43.tst: test for MultiSeries[multiseries] (no. 43)
...
#test 5
   ...
   #=============== test nb 43 =====================
   Order:=4;
   TRY[compare_SERIES]("43-1",
    op([assign(s=multiseries(op([exp(1/x+x), x, 4]))),SERIES2Series(s)]),
