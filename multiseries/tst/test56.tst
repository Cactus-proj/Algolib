...
#test 5
   ...
   #=============== test nb 56 =====================
   Order:=4;
   TRY[compare_SERIES]("56-1",
    op([assign(s=multiseries(op([exp(x^Pi+x^(2^(1/2))), x, 4]))),SERIES2Series(s)]),
    Series([1, 1, 1/2, 1],1,rational,[0, 2^(1/2), 2*2^(1/2), Pi],3*2^(1/2),
    algebraic,_var[x],exp(_var[x]^Pi+_var[x]^(2^(1/2)))));
   unassign('s');
