...
# test21.tst: test for MultiSeries[multiseries] (no. 21)
...
#test 5
   ...
   #=============== test nb 21 =====================
   Order:=5;
   TRY[compare_SERIES]("21-1",
    op([assign(s=multiseries(op([1/x, x, 5]))),SERIES2Series(s)]),
    Series([1],0,integer,[-1],infinity,integer,_var[x],1/_var[x]));
   unassign('s');
