...
# test44.tst: test for MultiSeries[multiseries] (no. 44)
...
#test 5
   ...
   #=============== test nb 44 =====================
   Order:=2;
   TRY[compare_SERIES]("44-1",
    op([assign(s=multiseries(op([exp(1/x+exp(-1/x)), x, 2]))),SERIES2Series(s)]),
