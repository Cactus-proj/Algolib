...
# test42.tst: test for MultiSeries[multiseries] (no. 42)
...
#test 8
   ...
   #=============== test nb 42 =====================
   Order:=4;
   TRY[compare_SERIES]("42-1",
    op([assign(s=multiseries(op([exp(1/(1/x+exp(-1/x))), x, 4]))),SERIES2Series(s)]),
    Series([Series([1, 1, 1/2, 1/6],1,rational,[0, 1, 2, 3],4,integer,_var[x],
    exp(_var[x]))],
    Series([],1,integer,[],2,integer,_var[x],-_var[x]^2),t_SERIES,
    [0],1,integer,_var[1/exp(1/x)],
    exp(_var[x])*exp(1/(1/_var[x]+_var[1/exp(1/x)])-_var[x])));
   TRY[compare_SERIES]("42-2",
    ...
    (-_var[x]^4-_var[x]^5-1/6*_var[x]^6)*exp(_var[x])],x^5,algebraic,
    [0, 1, 2, 3],4,integer,_var[1/exp(1/x)],
    exp(_var[x])*exp(1/(1/_var[x]+_var[1/exp(1/x)])-_var[x])));
   TRY[compare_SERIES]("42-3",
member(    SERIES2Series(multiseries(op(9,s),op(1,s))),
[
    Series([Series([1, 1, 1/2, 1/6],1,rational,[0, 1, 2, 3],
    4,integer,_var[x],exp(_var[x])),
    Series([-1, -1, -1/2, -1/6],1,rational,[2, 3, 4, 5],6,integer,
    _var[x],-_var[x]^2*exp(_var[x])),
    Series([1, 3/2, 1, 5/12],1,rational,[3, 4, 5, 6],7,integer,_var[x],
    (_var[x]^3+1/2*_var[x]^4)*exp(_var[x])),
    Series([-1, -2, -5/3, -5/6],1,rational,[4, 5, 6, 7],8,integer,_var[x],
    (-_var[x]^4-_var[x]^5-1/6*_var[x]^6)*exp(_var[x]))],
    Series([],1,integer,[],5,integer,_var[x],
    _var[x]^5+3/2*_var[x]^6+1/2*_var[x]^7+1/24*_var[x]^8),
...
# different number of terms
    ...
    Series([-1, -1, -1/2, -1/6],1,rational,[2, 3, 4, 5],6,integer,
    _var[x],-_var[x]^2*exp(_var[x])),
    Series([1],1,integer,[3],4,integer,_var[x],
    (_var[x]^3+1/2*_var[x]^4)*exp(_var[x])),
    Series([-1, -2, -5/3, -5/6],1,rational,[4, 5, 6, 7],8,integer,_var[x],
    (-_var[x]^4-_var[x]^5-1/6*_var[x]^6)*exp(_var[x]))],
    Series([],1,integer,[],5,integer,_var[x],_var[x]^5+3/2*_var[x]^6+1/2*_var[x]^7+1/24*_var[x]^8),
    t_SERIES,[0, 1, 2, 3],4,integer,_var[1/exp(1/x)],
    exp(_var[x])*exp(1/(1/_var[x]+_var[1/exp(1/x)])-_var[x]))
]),true);
   TRY[compare_SERIES]("42-4",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,exact_order)),
    Series([Series([1, 1, 1/2, 1/6],1,rational,[0, 1, 2, 3],4,integer,_var[x],
    exp(_var[x])),
    Series([-1, -1, -1/2, -1/6],1,rational,[2, 3, 4, 5],6,integer,_var[x],
    -_var[x]^2*exp(_var[x])),
    Series([1, 3/2, 1, 5/12],1,rational,[3, 4, 5, 6],7,integer,_var[x],
    (_var[x]^3+1/2*_var[x]^4)*exp(_var[x])),
    Series([-1, -2, -5/3, -5/6],1,rational,[4, 5, 6, 7],8,integer,_var[x],
