...
# test45.tst: test for MultiSeries[multiseries] (no. 45)
...
#test 5
   ...
   #=============== test nb 45 =====================
   Order:=3;
   TRY[compare_SERIES]("45-1",
    op([assign(s=multiseries(op([exp(1/x-exp(-1/x)), x]))),SERIES2Series(s)]),
    Series([Series([1],0,integer,[0],infinity,integer,_var[x],1)],
    Series([],1,integer,[],0,integer,_var[x],-1),t_SERIES,[-1],0,integer,
    _var[1/exp(1/x)],exp(-_var[1/exp(1/x)])/_var[1/exp(1/x)]));
   TRY[compare_SERIES]("45-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][2..2])),
    Series([1, -1, 1/2],1,rational,[-1, 0, 1],2,integer,_var[1/exp(1/x)],
    exp(-_var[1/exp(1/x)])/_var[1/exp(1/x)]));
   TRY[compare_SERIES]("45-3",
    ...
    Series([],1,integer,[],0,integer,_var[x],1),t_SERIES,[-1, 0, 1],2,
    integer,_var[1/exp(1/x)],exp(-_var[1/exp(1/x)])/_var[1/exp(1/x)]));
   TRY[compare_SERIES]("45-4",
