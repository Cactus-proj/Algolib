...
# test31.tst: test for MultiSeries[multiseries] (no. 31)
...
#test 5
   ...
   TRY[compare_SERIES]("31-2",
    SERIES2Series(multiseries(op(9,s),op(1,s),Order,op(1,s)[list][2..2])),
    Series([1, 1],0,integer,[0, 1],infinity,integer,_var[1/exp(1/x)],
    1+_var[1/exp(1/x)]));
   TRY[compare_SERIES]("31-3",
    SERIES2Series(multiseries(op(9,s),op(1,s))),
    Series([Series([1],0,integer,[0],infinity,integer,_var[x],1),
    Series([1],0,integer,[0],infinity,integer,_var[x],1)],0,
    t_SERIES,[0, 1],infinity,integer,_var[1/exp(1/x)],1+_var[1/exp(1/x)]));
   TRY[compare_SERIES]("31-4",
