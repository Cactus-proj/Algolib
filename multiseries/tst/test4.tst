...
# test4.tst: test for MultiSeries[multiseries] (no. 4)
...
#test 5
   ...
   #=============== test nb 4 =====================
   Order:=4;
   TRY[compare_SERIES]("4-1",
    op([assign(s=multiseries(op([1+Pi, x, 4]))),SERIES2Series(s)]),
    Series([1+Pi],0,algebraic,[0],infinity,integer,_var[x],1+Pi));
   unassign('s');
