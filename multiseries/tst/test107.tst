...
# test107.tst: test for MultiSeries[multiseries] (no. 107)
...
#test 5
   ...
   #=============== test nb 107 =====================
   Order:=2;
   TRY[compare_SERIES]("107-1",
    op([assign(s=multiseries(op([GAMMA(3*cos(x)-21), x, 2, exact_order]))),
    SERIES2Series(s)]),
    Series([-1/9603560558592000, 42142223/78443419212268830720000-
    1/6402373705728000*gamma],1,algebraic,[-2, 0],2,integer,_var[x],
    Pi/sin(Pi*(3*cos(_var[x])-21))/GAMMA(22-3*cos(_var[x]))));
   unassign('s');
