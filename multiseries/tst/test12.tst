...
# test12.tst: test for MultiSeries[multiseries] (no. 12)
...
#test 5
   ...
   #=============== test nb 12 =====================
   Order:=1;
   TRY[compare_SERIES]("12-1",
    op([assign(s=multiseries(op([(x+x^2)^3, x, 1, exact_order]))),SERIES2Series(s)]),
    Series([1],1,integer,[3],4,integer,_var[x],(_var[x]+_var[x]^2)^3));
   unassign('s');
